...
const EntryScreen = ({ navigation }) => {
  ...
  const handleAddHike = async () => {
    // if (!nameHike || !locationHike || !dateHike || !parking || !lengthHike || !difficulty ) {
    //   Alert.alert("Error", "Please fill in all fields");
    //   return;
    // }
    console.log(nameHike);
    console.log(locationHike);
    console.log(dateHike);
    console.log(parking);
    console.log(lengthHike);
    console.log(difficulty);
    console.log(description);

    await Database.addHike(nameHike, locationHike, dateHike, parking, lengthHike, difficulty, description);
